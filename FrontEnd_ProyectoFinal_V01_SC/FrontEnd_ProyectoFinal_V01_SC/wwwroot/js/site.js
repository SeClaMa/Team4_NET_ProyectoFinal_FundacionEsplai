...
//Funcion de API a Trabajadores. Recibe todo el listado de trabajadores. Los pinto como tabla-grid a partir de kendo
...
//Funcion que muestra los datos de los trabajadores a partir del cuerpo recibido como parametro. Pinta la tabla con kendo
...
//Funcion que guarda los datos de un empleado obtenidos a partir del endpoint en una variable para posteriormente pintar el pdf de sepe
function generar_pdf(empleado) {
    $.ajax({
        ...
        success: function (data) {
            ...
            pintar_pdf(datos_empleado); //llama a la función que rellenará el pdf
        },
...
//Funcion de API para traer los cuerpos a partir del endpoint preparado para ello
function Cuerpos() {
    $.ajax({
        ...
        success: function (data) {
            ...
            displayValues(stored_datas); //llama a la función que va a pintar los cuerpos como botones a partir del array suministrado
        },
        error: function (error) {
            console.log(error);
        }
...
//funcion que a partir de la varible que guarda el array de los cuerpos los pinta como botones 
function displayValues(stored_datas) {
    ...
    stored_datas.forEach((i) => {
        ...
        document.getElementById("cuerpos").innerHTML += "<button class='btnn' onclick=\"FiltroCuerpo('" + i.cuerpo + "');\"><i class='bi bi-building'></i > " + i.descrip + "</button>"; //al pinchar el botón llama a la función que muestra los trabajadores por cuerpo
    })
}

//Funcion para rellenar el PDF a partir del parametro recibido (el id del empleado). Nos hemos apoyado en la librería https://pdf-lib.js.org/, que es cargada en el fichero layout.
